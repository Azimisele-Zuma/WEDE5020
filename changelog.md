...
Enquiry form validation: Fixed backend/validation issues to ensure the enquiry form submits user data successfully.
Sitemap alignment: Updated structure to match the initial wireframe blueprints.
## Removed
